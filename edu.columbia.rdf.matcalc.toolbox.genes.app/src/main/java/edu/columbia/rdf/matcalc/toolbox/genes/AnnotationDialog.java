...
public class AnnotationDialog extends ModernDialogHelpWindow {
	...
	private ModernTwoStateWidget mCheckOverlappingGenes = 
			new ModernCheckSwitch("Overlapping", true);
	
	private ModernTwoStateWidget mCheckClosestGene = 
			new ModernCheckSwitch("1st closest", true);
	
	private ModernTwoStateWidget mCheck2ndClosestGene = 
			new ModernCheckSwitch("2nd closest");
	
	private ModernTwoStateWidget mCheck3rdClosestGene = 
			new ModernCheckSwitch("3rd closest");
	
	private ModernTwoStateWidget mCheck4thClosestGene = 
			new ModernCheckSwitch("4th closest");
	
	private ModernTwoStateWidget mCheck5thClosestGene = 
			new ModernCheckSwitch("5th closest");
	
	private ModernTwoStateWidget mCheckOtherClosest = 
			new ModernCheckSwitch("nth closest");
	...
	private ModernCompactSpinner mTextExt3p = 
			new ModernCompactSpinner(0, 100000, 1000, 1000, false);


	private ModernClipboardTextField mTextOtherClosest =
			new SuggestionTextBox("e.g. 1,2,4-6");
